          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="inline-flex items-center px-3 py-1.5 md:px-4 md:py-2 rounded-full glass border border-accent/20 glow-accent mb-4 md:mb-6">
              ...
              <span className="text-xs md:text-sm font-medium text-accent">
                Cyberjaya Smart City Initiative
              </span>
            </div>
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed px-4">
              Empowering every stakeholder in Cyberjaya's retail ecosystem
              through data-driven insights and blockchain innovation.
            </p>
          </div>
              ...
              <CardContent className="p-6 md:p-8 text-center h-full flex flex-col">
                ...
                <ul className="text-muted-foreground space-y-3 md:space-y-4 text-left flex-1">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-sm md:text-base">
                      Access investment capital through tokenization
                    </span>
                  </li>
                  <li className="flex items-start">
        ...
        <div className="container mx-auto px-4 max-w-screen-xl">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto px-4">
              A seamless flow from retail data to blockchain-powered revenue
              sharing
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Historical sales, inventory, and customer data feeds our AI algorithms",
                  icon: BarChart3,
                  color: "primary",
                },
                {
                  ...
                  description:
                    "Machine learning predicts demand, optimal inventory, and revenue projections",
                  icon: Zap,
                  color: "secondary",
                },
                {
                  ...
                  description:
                    "Blockchain creates secure tokens representing future profit shares",
                  icon: Shield,
                  color: "accent",
                },
                {
                  ...
                  description:
                    "Community members buy tokens to support local businesses and earn returns",
                  icon: Coins,
                  color: "success",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6 lg:gap-8 p-4 md:p-6 glass rounded-xl hover-lift"
                >
                  <div
                    className={`w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center glow-${
                      item.color
                    } flex-shrink-0 ${
                      item.color === "primary"
                        ? "bg-gradient-primary"
        ...
        <div className="container mx-auto px-4 text-center max-w-screen-xl">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-muted-foreground mb-6 md:mb-8 px-4">
              Join the revolution in smart city retail innovation. Start with AI
              forecasting or explore investment opportunities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              <Button
                onClick={handleForecastClick}
                size="lg"
                className="bg-gradient-primary hover-glow text-primary-foreground px-6 md:px-8 w-full sm:w-auto"
              >
                {isAuthenticated ? "Start Forecasting" : "Sign In to Forecast"}
                <BarChart3 className="ml-2 h-4 w-4 md:h-5 md:w-5" />
              </Button>
              <Button
                onClick={handleTokenizationClick}
                variant="outline"
                size="lg"
                className="glass border-primary/30 hover:bg-primary/10 px-6 md:px-8 w-full sm:w-auto"
              >
                {isAuthenticated
                  ? "Explore Tokenization"
                  : "Sign In to Tokenize"}
                <Coins className="ml-2 h-4 w-4 md:h-5 md:w-5" />
              </Button>
            </div>
          </div>
        </div>
